...
# Variables
REPO_PATH="/home/masuma/Desktop/practice/business-blog/"  # Path to your local repository
REMOTE_URL="https://github.com/abdurrahim220/business-next.git"  # Remote repository URL
