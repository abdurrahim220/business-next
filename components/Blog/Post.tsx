...
import PostDate from './Post-Data'
    ...
    <article className="h-full flex flex-col space-y-5" data-aos="fade-up">
      {props.image &&
        <Link className="block group overflow-hidden" href={`/blog/${props.slug}`}>
          <Image className="w-full aspect-[16/9] md:aspect-[27/17] object-cover group-hover:scale-105 transition duration-700 ease-out" src={props.image} width={540} height={340} alt={props.title} />
        </Link>
      }
